...
export default function EmptyStateHome({
	...
	return (
		<div className='mx-auto max-w-6xl space-y-8'>
			<section className='relative overflow-hidden rounded-3xl border border-blue-100 bg-gradient-to-b from-blue-100 via-indigo-50 to-violet-100 p-8 text-slate-900 shadow-[0_24px_55px_-42px_rgba(59,130,246,0.45)] sm:p-10'>
				...
				<div className='relative z-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between'>
					...
					<button
						...
						className='inline-flex items-center justify-center gap-2 rounded-xl border border-blue-300 bg-gradient-to-b from-blue-600 to-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_28px_-18px_rgba(37,99,235,0.85)] transition-colors hover:from-blue-700 hover:to-violet-700 disabled:cursor-not-allowed disabled:opacity-70'
					>
			...
			<section className='rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8'>
				<div className='mb-5 flex items-center justify-between gap-4'>
					<div>
						<h2 className='text-2xl font-bold text-slate-900'>Scan New Project</h2>
