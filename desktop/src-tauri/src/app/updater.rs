use crate::user_settings::{save_user_settings, UserSettings};
use reqwest::Client;
use serde::{Serialize};
...
pub async fn check_for_updates(settings: &mut UserSettings) -> Result<UpdateCheck, String> {
...
pub async fn start_update_checker(mut settings: UserSettings) {
